...
private:
	...
	fpreal  STEP_SIZE(fpreal t) { return evalFloat("step_size", 0, t); };
	fpreal  ITERATION(fpreal t) { return evalInt("iteration", 0, t); };
	// here I refer to SOP_BouncyAgent.h function AGENTNAME
	void GRAMMAR_FILE(UT_String &s, fpreal t)	{ evalString(s, "grammar_file", 0, t); }
